...
% 2019 11 12
% Totally redesign the filtering using a linear combination of the area to
% convex area ratio and the aspect ratio
function [CCstats,BW1e] = ConvexFilter(CC,BW1d,FN1a)
...
% have b = -12.5.  So we have:   y = 12.8571x - 12.5
...
CCstats.y = (12.8571 * CCstats.AreaRatio) - 12.5;
